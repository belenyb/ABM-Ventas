...
if ($_POST) {
  $usuario = trim($_POST["txtUsuario"]); // trim: para eliminar espacios de más
  ...
  $entidadUsuario->obtenerPorUsuario($usuario);
    if($entidadUsuario->verificarClave($clave, $entidadUsuario->clave)) {
      // Si es correcto, creamos una variable de session llamada nombre, con el nombre de ustedes
      $_SESSION["nombre"] = $entidadUsuario->nombre;
      // Redireccionamos a la home
      header('location: index.php');
    } else {
      // Si no es correcta la clave o el usuario, mostrar en pantalla "Usuario o clave incorrecto"
                ...
                <div class="p-5"> 
                  ...
                  <form class="user" action="" method="POST">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="txtUsuario" name="txtUsuario" aria-describedby="emailHelp" placeholder="Usuario" value="byarde">
                    </div>
                    <div class="form-group">
                  ...
                  <div class="text-center">
                    <a class="small" href="register.html">¡Creá una cuenta!</a>
                  </div>
                </div>
              </div>
            </div>
